      ...
      <div className='grid lg:grid-cols-2 gap-12 items-center'>
        ...
        <div className='space-y-8'>
                ...
                <div className='space-y-4'>
                  ...
                  <p className='text-lg text-muted-foreground max-w-lg animate-fade-in delay-3'>
                    Hi, i am vasanth - a front end developer specialsing in react, next.js, and typescript. i build scalable, performant web applicants that users love.
                  </p>
